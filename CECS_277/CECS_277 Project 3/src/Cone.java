...
public class Cone extends Circle implements Movable{
	 ...
	 * @param c
	 */
	public Cone(double h, double r, String c)
	{
		super(r, c);
		height = h;
	}
	...
	public double getVolume() {
		return super.getArea() * height * (1.0/3.0);
	}
	
	public double getSurfaceArea() {
		return super.getArea() + (Math.PI * super.getRadius() * Math.sqrt(Math.pow(height, 2) + Math.pow(super.getRadius(), 2)));
	}
